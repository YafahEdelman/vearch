...
from caffe import Classifier,set_mode_cpu
...
def word_probs(image_names,word_to_search, max_to_look=50):
    ...
    return ret
#test_images=[caffe_root+'examples/images/cat.jpg',caffe_root+'examples/images/fish-bike.jpg']
#test_word="cat"
